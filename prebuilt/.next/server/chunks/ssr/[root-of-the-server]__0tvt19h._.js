module.exports=[22734,(a,b,c)=>{b.exports=a.x("fs",()=>require("fs"))},45739,a=>{"use strict";var b=a.i(94495);a.s([],50016),a.i(50016),a.s(["40a384e53220b91d7724f9ab7f49afded40d5b6fd4",()=>b.deleteEntry,"40b785975ad04e70c3c55e3d576276eccfd3cdbd05",()=>b.addEntry,"6069b4c6889746ef7daccd8962036953e47f1c653a",()=>b.updateEntry],45739)},51476,12798,a=>{"use strict";var b=a.x("node:sqlite",()=>require("node:sqlite"),!0),c=a.i(22734),d=a.i(14747);let e=new Proxy({},{get(e,f){let g=function(){if(a.g.__journalDb)return a.g.__journalDb;let e=process.env.SDNLOG_DATA_DIR?d.default.resolve(process.env.SDNLOG_DATA_DIR):d.default.join(process.cwd(),"data");c.default.existsSync(e)||c.default.mkdirSync(e,{recursive:!0});let f=new b.DatabaseSync(d.default.join(e,"journal.db"));return f.exec("PRAGMA busy_timeout = 5000"),f.exec("PRAGMA journal_mode = WAL"),f.exec("PRAGMA foreign_keys = ON"),f.exec(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0tvt19h._.js.map